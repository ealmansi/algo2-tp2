...
\algoritmoIvoid{AsegurarIdsConsecutivos}{\param{in/out}{ids}{vector(idGrupoAliados)}, \param{in}{idBorrado}{idGrupoAliados}}
{
...
\algoritmoI{ObtenerIdGrupoDeAliados}{\param{in}{sl}{estrS}, \param{in}{gr}{puntero(gremio)}}{\param{}{res}{idGrupoAliados}}
{
	\state res \asig sl.gruposDeAliados[ObtenerId(*gr)]
}
{0}

\algoritmoIvoid{GuardarIdGrupoAliados}{\param{in/out}{sl}{estrS}, \param{in}{gr}{puntero(gremio)}, \param{in}{id}{idGrupoAliados}}
{
...
\algoritmoI{ObtenerProximoIdGrupoDeAliados}{\param{in}{sl}{estrS}}{\param{}{res}{idGrupoAliados}}
{
...
\algoritmoI{Min}{\param{in}{id1}{idGrupoAliados}, \param{in}{id2}{idGrupoAliados}}{\param{}{res}{idGrupoAliados}}
{
	\If{id1 \menor id2}
		\state res \asig id1
	\Else
...
\algoritmoI{Max}{\param{in}{id1}{idGrupoAliados}, \param{in}{id2}{idGrupoAliados}}{\param{}{res}{idGrupoAliados}}
{
	\If{id1 \menor id2}
		\state res \asig id2
	\Else
