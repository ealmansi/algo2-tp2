...
\tupla{\\
\hspace*{6em}\param{}{sistema}{sistemaLaboral},\\
\hspace*{6em}\param{}{paritariasAbiertas}{conj(puntero(paritaria))},\\
\hspace*{6em}\param{}{acuerdosVigentes}{vector(lista(puntero(acuerdo)))},\\
\hspace*{6em}\param{}{\#aperturas}{vector(nat)} \\\hspace*{2em} } \\
\\
\hline
\end{tabular}
\end{center}
