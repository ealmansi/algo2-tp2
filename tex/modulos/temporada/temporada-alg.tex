...
\\
Post : \ensuremath{ (tmp.\#acuerdosPrevios_{idgremio(gr)} \igobs tmp0.\#acuerdosPrevios_{idgremio(gr)}-1) \land ((\forall i:nat) (0 \leq idgremio(gr) < long(tmp.\#acuerdosPrevios) \land i \neq idgremio(gr)) \implies_L tmp0.\#acuerdosPrevios_i) \land (tmp.sistema \igobs tmp0.sistema) \land (tmp.paritariasAbiertas \igobs tmp0.paritariasAbiertas) \land (tmp.acuerdosPorGrupo \igobs tmp0.acuerdosPorGrupo)}
