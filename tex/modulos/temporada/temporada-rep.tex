...
\begin{RepFormal}{estrT}{e}
	...
	\repItem{(\paratodof{acuerdo}{ac})\, ac \in e.acuerdosVigentesPorGrupo \entoncesL gremio(ac) \in gremios(e.sistema)}{\lyl}
	
	\repItem{ \# gruposAliados(e.sistema) = longitud(e.acuerdosVigentesPorGrupo) }{\lyl}
	
	\repItem{ (\paratodof{gremio}{gr1,gr2}) (\, gr1 \in gremios(e.sistema) \ly gr2 \in gremios(e.sistema) \lyl  \\ \# acuerdos(gr1, e) = 1 \ly \# acuerdos(gr2, e) = 1) \entoncesL aliado?(e.sistema,gr1,gr2) \siii  \\ ((\exists \, ! i : nat) (0 \leq i \menor longitud(e.acuerdosVigentesPorGrupo)) \lyl \\ esta?(acuerdo(gr1,e.sistema), e.acuerdosVigentesPorGrupo[i]) \ly \\ esta?(acuerdo(gr2,e.sistema), e.acuerdosVigentesPorGrupo[i]))  }{\lyl}
	
	\repItem{(\paratodof{nat}{i})\, 0 \leq i \menor longitud(e.acuerdosVigentesPorGrupo) \entoncesL \\ estaOrdenadaPorPorcentaje(e.acuerdosVigentesPorGrupo[i]) }{\lyl}
	
	\repItem{(\paratodof{nat}{i})\, 0 \leq i \menor longitud(e.acuerdosVigentesPorGrupo) \entoncesL \\ ((\paratodof{acuerdo}{ac}) estáta?(ac, e.acuerdosVigentesPorGrupo[i]) \entoncesL \\ piso(paritaria(ac)) \leq porcentaje(ac) \leq tope(paritaria(ac))) }{\lyl}
	
	\repItem{longitud(e.\#acuerdosPrevios) = \#gremios(e.sistema) }{\lyl}
	
	\repItem{(\paratodof{gremio}{gr}) \, gr \in gremios(e.sistema) \lyl \# paritarias(gr, e) = 0 \ly \#acuerdos(gr, e) = 0 \entoncesL \# acuerdosPrevios[id(gr)] = 0 }{\lyl}
